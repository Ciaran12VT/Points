    ...
    public class AchievementDetailsViewModel : ObservableObject
    {
        ...
        public AchievementGoalType GoalType
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(nameof(IsTargetValueVisible));
        ...
        // Visibility helpers (keeps XAML simple)
        public bool IsTargetValueVisible => GoalType == AchievementGoalType.ActiveTime || GoalType == AchievementGoalType.Value;
