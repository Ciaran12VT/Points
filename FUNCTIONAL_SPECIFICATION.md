...
Modules & Features has enabled switches and integer screen orders for all seven panes, plus feature switches for Locks, Schedules, Value Rates, and Cash In. Save requires every order to be a whole number.
...
- Features: `LocksActive=true`, `SchedulesActive=true`, `ValueRatesActive=true`, `CashInActive=true`.
